...
const Settings = () => {
  const [settings, setSettings] = useState({
    facilityName: "Sân Bóng Đá Minh Khai",
    facilityDescription: "Sân bóng đá chất lượng cao với cỏ nhân tạo",
    contactEmail: "owner@datsanonline.com",
    ...
    <div style={{ display: "grid", gap: 24 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, boxShadow: "0 6px 20px rgba(0,0,0,.06)" }}>
        ...
        <div style={{ display: "grid", gap: 16 }}>
          ...
          <div>
            <label style={{ display: "block", marginBottom: 8, fontWeight: 600 }}>Giờ hoạt động</label>
            <input
              type="text"
