...
const FacilityDeleteModal = ({ isOpen, onClose, onConfirm, facility }) => {
        ...
        <div style={{ padding: 24, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 14, color: "#4b5563" }}>
              Hành động này sẽ xóa vĩnh viễn sân
              <strong style={{ margin: "0 4px" }}>{facility.name} (ID: {facility.id})</strong>.
