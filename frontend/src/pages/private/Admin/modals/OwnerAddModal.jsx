...
// Dữ liệu ban đầu cho chủ sân mới
const getInitialData = () => {
    const today = new Date().toISOString().split('T')[0];
    return {
        id: `O${Math.floor(100 + Math.random() * 900)}`, // Tạo ID ngẫu nhiên
        name: "",
        email: "",
        phone: "",
        facility: "",
...
const OwnerAddModal = ({ isOpen, onClose, onSave }) => {
