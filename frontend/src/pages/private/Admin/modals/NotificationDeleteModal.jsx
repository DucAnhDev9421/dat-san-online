...
const NotificationDeleteModal = ({ isOpen, onClose, onConfirm, notification }) => {
        ...
        <div style={{ padding: 24, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 14, color: "#4b5563" }}>
              Hành động này sẽ xóa vĩnh viễn thông báo
              <strong style={{ margin: "0 4px" }}>{notification.id}</strong>.
            </div>
          </div>
        </div>
