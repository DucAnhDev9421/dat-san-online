...
const OwnerDeleteModal = ({ isOpen, onClose, onConfirm, owner }) => {
        ...
        <div style={{ padding: 24, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 14, color: "#4b5563" }}>
              Hành động này sẽ xóa vĩnh viễn chủ sân
              <strong style={{ margin: "0 4px" }}>{owner.name} (ID: {owner.id})</strong>.
            </div>
          </div>
        </div>
